  ...
  static editBook = (event) => {
    event.preventDefault()
      var bookobj = {
        ...
        var bookdata = document.getElementById(event.path[5].attributes[4].value).children //change the row data
        bookdata[0].innerText = document.getElementById("title-edit-input").value
        bookdata[1].innerText = document.getElementById("author-edit-input").value
        bookdata[4].innerText = document.getElementById("synopsis-edit-input").value
        bookdata[5].innerText = document.getElementById("pages-edit-input").value
        bookdata[6].innerText = document.getElementById("date-edit-input").value

console.log("hello")
      axios.put(`${baseUrl}/library/update/${event.path[5].attributes[4].value}`,bookobj)
      .then(e => {
        console.log(e)})
